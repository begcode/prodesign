...
public class SiteConfigBaseService<R extends SiteConfigRepository, E extends SiteConfig>
    ...
    public SiteConfigDTO save(SiteConfigDTO siteConfigDTO) {
        ...
        this.createEntityAndRelatedEntities(siteConfig, siteConfig.getItems(), CommonFieldData::setSiteConfigId);
    ...
    public SiteConfigDTO update(SiteConfigDTO siteConfigDTO) {
        ...
        this.updateEntityAndRelatedEntities(siteConfig, siteConfig.getItems(), CommonFieldData::setSiteConfigId);
