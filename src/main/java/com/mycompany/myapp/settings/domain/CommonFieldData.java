...
public class CommonFieldData implements Serializable {
    ...
    @BindEntity(entity = SiteConfig.class, condition = "this.site_config_id=id")
    @JsonIgnoreProperties(value = { "items" }, allowSetters = true)
    private SiteConfig siteConfig;

    @TableField(value = "site_config_id")
    private Long siteConfigId;

    @TableField(exist = false)
    @BindEntity(entity = Dictionary.class, condition = "this.dictionary_id=id")
    @JsonIgnoreProperties(value = { "items" }, allowSetters = true)
    ...
    public CommonFieldData siteConfig(SiteConfig siteConfig) {
        this.siteConfig = siteConfig;
        return this;
    }

    public CommonFieldData dictionary(Dictionary dictionary) {
