...
import { addScript as appendScript, addStyle as appendStyle, copyObject, NODE_UID, NODE_TAG, NODE_LOOP } from '../common';
import { useCanvas, useLayout, useResource, useTranslate } from '@/controller';
...
export const dragStart = (data, element, { offsetX = 0, offsetY = 0, horizontal, vertical, width, height, x, y } = {}) => {
  // 表示鼠标按下开始拖拽
