<template>
  ...
  <canvas-resize>
    <iframe v-if="!loading" id="canvas" ref="iframe" :src="canvasSrc" style="border: none; width: 100%; height: 100%"></iframe>
...
import { iframeMonitoring } from '@/common/js/monitor';
import { useTranslate, useCanvas, useResource } from '@/controller';
