  ...
  <div>
    ...
    <config-group :group="propertiesList" :index="0">
      <template #item="{ data, propIndex }">
        <config-item :key="propIndex" :property="data" :data-prop-index="propIndex" :data-group-index="groupIndex" :isTopLayer="true">
          <template #prefix>
...
import { useResource, useProperties, useCanvas, useProperty } from '@/controller';
import { ConfigGroup, ConfigItem } from '@/common';
