<template>
  <tiny-popover trigger="hover" :open-delay="1000" popper-class="toolbar-right-popover" append-to-body content="刷新画布">
...
import { useResource, useCanvas, useModal, useLayout, useBlock } from '@/controller';
...
export default {
  ...
  props: {
    icon: {
      type: String,
      default: 'ant-design:reload-outlined',
    },
  },
  setup() {
