<template>
  ...
  <div>
    ...
    <BasicModal v-bind="modalConfig" @register="registerModal" @cancel="closeModal" @ok="okModal">
      <component :is="modalConfig.componentName" @cancel="closeModal" @refresh="formSearch" v-bind="modalConfig" ref="modalComponentRef" />
    </BasicModal>
...
<script lang="ts" src="./jdl-field-list.component.ts"></script>
<style scoped></style>
