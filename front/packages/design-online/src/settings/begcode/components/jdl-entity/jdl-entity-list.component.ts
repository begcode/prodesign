...
import SmsConfigEdit from './jdl-entity-edit.vue';
import SmsConfigDetail from './jdl-entity-detail.vue';
...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const apis = {
      ...
      recycleBin: apiService.files.smsConfigService.recycleBin,
      restoreByIds: apiService.files.smsConfigService.restoreByIds,
      reallyDelete: apiService.files.smsConfigService.reallyDelete,
      emptyRecycleBin: apiService.files.smsConfigService.emptyRecycleBin,
      findInRecycleBin: apiService.files.smsConfigService.findInRecycleBin,
    };
    const pageConfig = {
      title: '短信配置列表',
        ...
        ajax: {
          query: async ({ filters, page, sort, sorts }) => {
            ...
            if (showRecycleBin.value) {
              return await apis.recycleBin(queryParams);
            } else {
