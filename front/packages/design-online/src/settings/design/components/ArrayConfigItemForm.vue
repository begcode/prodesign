  ...
  <div class="array-item-config-container">
    ...
    <tiny-form class="config-item-form" label-position="left">
      ...
      <tiny-form-item label="值类型">
        <tiny-select v-model="store.currentSubConfig.type" :options="META_TYPES_OPTIONS" @change="changeType"></tiny-select>
      </tiny-form-item>
      <tiny-form-item label="设计器">
        <tiny-select v-model="store.currentSubConfig.widget.component" :options="widgetNames" @change="changeType"></tiny-select>
      </tiny-form-item>
      ...
      <tiny-form-item label="缺省值">
        <component :is="component" :modelValue="defaultValue" class="default-component" @update:modelValue="handleSaveDefaultValue">
        </component>
      </tiny-form-item>
...
import { Input as TinyInput, Form as TinyForm, FormItem as TinyFormItem, Select as TinySelect } from 'ant-design-vue';
import { ConfigItem, MetaCodeEditor, MetaInput, MetaNumber, MetaSwitch } from '@/common';
