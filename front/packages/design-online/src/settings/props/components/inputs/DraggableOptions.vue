...
import { IconDel, IconWriting, IconMore, IconLanguage, IconClose, IconNew, IconEdit, IconPlus, IconCode } from '@opentiny/vue-icon';
import { useProperties, useResource, useCanvas } from '@/controller';
import { MetaList, MetaListTitle, MetaListActions, MetaListItems } from '@/common';
