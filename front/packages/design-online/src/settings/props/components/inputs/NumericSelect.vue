<template>
  <div class="numeric-input">
    <tiny-numeric v-model="value" :controls-position="controlsPosition" :min="min" :max="max" :step="step" @change="change"></tiny-numeric>
    <div v-if="showText" class="text">
      <tiny-select v-model="textValue" popper-class="select-popper" :options="textList" size="mini" @change="change"></tiny-select>
    </div>
  </div>
</template>
