...
import { useCanvas, useHistory, useProperties as useProps } from '@/controller';
import { camelize } from '@/controller/utils';
import { obj2StyleStr } from '@/common/js/css';
import { updateRect, getSchema as getCanvasPageSchema } from '@/canvas';
