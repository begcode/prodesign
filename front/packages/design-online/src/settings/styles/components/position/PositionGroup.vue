<template>
  <div class="position-group">
    ...
    <div class="position-select">
      <meta-select :modelValue="state.selectValue" :options="selectOptions" @update:modelValue="selectPosition"></meta-select>
    </div>
      ...
      <div v-if="state.showSettingIcon" class="tooltip-wrap">
        <div class="tooltip-icon">
          <tiny-tooltip
            ...
            :content="item.tip"
          >
            <span :class="['icon-wrap', { selected: index === state.selectedIndex }]" @click="selectInsetValue(item, index)"
...
import { MetaSelect } from '@/common';
import { camelize } from '@/controller/utils';
