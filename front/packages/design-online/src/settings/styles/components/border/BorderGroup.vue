<template>
  <div :class="['radius-row', { 'show-border': isRaduisSelected(RADIUS_SETTING.Single) }]">
    <div :class="['radius-label', { 'is-setting': isRadiusSetting() }]" @click="openSetting(BORDER_RADIUS_PROPERTY.BorderRadius, $event)">
      圆角
    </div>
  ...
  <div class="border-label">
    <span :class="{ 'is-setting': isBorderSetting(), 'set-border-style': true }" @click="openSetting(BORDER_PROPERTY.Border, $event)"
      >边框</span
    >
  ...
  <div class="border-input">
    <div class="border-input-right">
      <div class="border-row">
        <div class="border-label">
          <span :class="{ 'is-setting': isBorderColorSetting() }" @click="openSetting(BORDER_PROPERTY.BorderColor, $event)">颜色</span>
        </div>
      ...
      <div class="border-row">
        <div class="border-label">
          <span :class="{ 'is-setting': isBorderWidthSetting() }" @click="openSetting(BORDER_PROPERTY.BorderWidth, $event)">宽度</span>
        </div>
        ...
        <div class="border-label">
          <span :class="{ 'is-setting': isBorderStyleSetting() }" @click="openSetting(BORDER_PROPERTY.BorderStyle, $event)">样式</span>
        </div>
...
import { MetaColor, MetaSlider } from '@/common';
...
// import { hyphenate } from '@/controller/utils'
