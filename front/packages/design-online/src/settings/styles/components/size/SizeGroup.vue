<template>
  <div class="size-row">
    <div class="size-col">
      <div :class="['size-label', { 'is-setting': getSettingFlag(SIZE_PROPERTY.Width) }]" @click="openSetting(SIZE_PROPERTY.Width, $event)">
        宽(W)
      </div>
      <numeric-select
  ...
  <div class="overflow-row">
    ...
    <div class="overflow-content">
      <tiny-tooltip :effect="effect" :placement="placement" content="visible 溢出可见">
        ...
        >
          <Icon icon="eye|svg" class="overflow-svg"></Icon>
        </div>
      </tiny-tooltip>
      ...
      <tiny-tooltip :effect="effect" :placement="placement" content="hidden 溢出隐藏">
        ...
        >
          <Icon icon="eye-invisible|svg" class="overflow-svg"></Icon>
        </div>
      </tiny-tooltip>
      ...
      <tiny-tooltip :effect="effect" :placement="placement" content="overflow 溢出滚动">
        ...
        >
          <Icon icon="overflow-scroll|svg" class="overflow-svg"></Icon>
        </div>
      </tiny-tooltip>
  ...
  <div class="fit-row">
    ...
    <tiny-tooltip :effect="effect" :disabled="state.disabled" :placement="placement" content="Object position 设置">
      <tiny-popover placement="bottom" popper-class="toolbar-media-popper fit-popper" @show="showPopover" @hide="hidePopover">
        <span :class="['more-icon-wrap', { selected: state.flag, 'is-setting': getSettingFlag(SIZE_PROPERTY.ObjectPosition) }]">
          ...
          <div class="size-fit-content">
            ...
            <div class="size-fit-content-main">
              <div class="coordinate">
                ...
                >
                  <Icon v-if="state.originActive !== index" :icon="item.pointIcon"></Icon>
                  <Icon v-else :icon="item.originIcon"></Icon>
                </div>
              </div>
...
import { MetaSelect, MaskModal } from '@/common';
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const originOptions = [
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-top-left|svg',
        left: '0',
        top: '0',
      },
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-top|svg',
        left: '50',
        top: '0',
      },
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-top-right|svg',
        left: '100',
        top: '0',
      },
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-left|svg',
        left: '0',
        top: '50',
      },
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-center|svg',
        left: '50',
        top: '50',
      },
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-right|svg',
        left: '100',
        top: '50',
      },
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-bottom-left|svg',
        left: '0',
        top: '100',
      },
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-bottom|svg',
        left: '50',
        top: '100',
      },
      {
        pointIcon: 'transform-origin-point|svg',
        originIcon: 'transform-origin-bottom-right|svg',
        left: '100',
        top: '100',
      },
    ];
