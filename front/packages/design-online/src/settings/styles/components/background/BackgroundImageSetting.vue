  ...
  <div class="background-image-setting">
    <div class="background-row line">
      ...
      <div class="row-content">
        ...
        >
          <div
            :class="['row-content-item background-type-item', { selected: state.styleComponent === item.styleComponent }]"
    ...
    <div class="background-image-content">
      <component :is="state.styleComponent" :style="style" :effect="effect" :placement="placement" @updateStyle="updateStyle" />
    </div>
  </div>
</template>
