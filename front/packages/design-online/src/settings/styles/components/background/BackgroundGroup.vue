<template>
  <div class="background-group">
    <div class="background-image-wrap">
      <div class="background-image">
        <label
          ...
          >背景图 & 渐变</label
        >
        <tiny-tooltip effect="dark" placement="top" title="添加背景图，线性渐变，径向渐变等">
    ...
    <div class="background-clip">
      ...
      <div class="position-select">
        <meta-select :modelValue="state.selectValue" :options="selectOptions" @update:modelValue="selectBackgroundClip"></meta-select>
      </div>
    </div>
  </div>
  ...
  <modal-mask v-if="state.showBackgroundImageModal" @close="state.showBackgroundImageModal = false">
    <background-image-setting :style="state.currentBackgroundImage" @update:modelValue="updateCurrentBackground"></background-image-setting>
  </modal-mask>
</template>
    ...
    const openSetting = (name, event) => {
      if (getSettingFlag(name)) {
        if (name === 'background-clip') {
          ...
          activedName = [BACKGROUND_PROPERTY.BackgroundImage, BACKGROUND_PROPERTY.BackgroundPosition, BACKGROUND_PROPERTY.BackgroundSize];
        } else {
          activedName = [name];
        }
