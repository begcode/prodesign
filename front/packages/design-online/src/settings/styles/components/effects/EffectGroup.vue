<template>
  ...
  <div class="effect-group line outline-wrap">
    ...
    <div class="outline-content">
      <tiny-tooltip effect="dark" placement="top" title="none-无">
        <div
        ...
        >
          <Icon icon="cross|svg"></Icon>
        </div>
      </tiny-tooltip>
      <tiny-tooltip effect="dark" placement="top" title="solid-实线">
        <div
        ...
        >
          <Icon icon="border-style-solid|svg"></Icon>
        </div>
      </tiny-tooltip>
      <tiny-tooltip effect="dark" placement="top" title="dashed-虚线">
        <div
        ...
        >
          <Icon icon="border-style-dashed|svg"></Icon>
        </div>
      </tiny-tooltip>
      <tiny-tooltip effect="dark" placement="top" title="dotted-圆点">
        <div
        ...
        >
          <Icon icon="border-style-dotted|svg"></Icon>
        </div>
      </tiny-tooltip>
    </div>
  ...
  <div class="effect-group line cursor-wrap">
    ...
    >
    <div>
      <tiny-select v-model="state.cursorValue" placeholder="请选择" @change="cursorChange" style="width: 120px">
        <tiny-option-group v-for="group in cursorGroup" :key="group.label" :label="group.label" :disabled="group.disabled">
...
import { MetaSlider, MetaColor } from '@/common';
...
export default {
  components: {
    ...
    TinyOptionGroup: SelectOptGroup,
    TinyTooltip: Tooltip,
    MetaSlider,
    MetaColor,
    ModalMask,
  ...
  setup(props, { emit }) {
    ...
    const setOutlineStyle = () => {
      updateStyle({
        [EFFECTS_PROPERTY.Outline]: `${state.outlineWidth + state.outlineWidthSuffix} ${state.activedType} ${state.outlineColor}`,
      });
    };
