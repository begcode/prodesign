    ...
    <div class="typography-row">
      ...
      <div class="typography-content">
        ...
        <tiny-tooltip :effect="effect" :placement="placement" content="Center-居中对齐">
          <div :class="['typography-content-item', { selected: isAlignSelected('center') }]" @click="selectAlign('center')">
            <svg-icon name="text-align-center" class="bem-Svg"></svg-icon>
          </div>
        </tiny-tooltip>

        <tiny-tooltip :effect="effect" :placement="placement" content="Right-右对齐">
          <div :class="['typography-content-item', { selected: isAlignSelected('right') }]" @click="selectAlign('right')">
            <svg-icon name="text-align-right" class="bem-Svg"></svg-icon>
          </div>
        </tiny-tooltip>

        <tiny-tooltip :effect="effect" :placement="placement" content="Justify-两侧对齐">
          <div :class="['typography-content-item', { selected: isAlignSelected('justify') }]" @click="selectAlign('justify')">
      ...
      <div class="typography-style">
        <div class="typography-content italicize">
          <tiny-tooltip :effect="effect" :placement="placement" content="Regular-常规">
            <div :class="['typography-content-item', { selected: isFontStyleSelected('normal') }]" @click="selectFontStyle('normal')">
              <svg-icon name="font-style-none" class="bem-Svg"></svg-icon>
            </div>
          </tiny-tooltip>

          <tiny-tooltip :effect="effect" :placement="placement" content="Italic-斜体">
            <div :class="['typography-content-item', { selected: isFontStyleSelected('italic') }]" @click="selectFontStyle('italic')">
    ...
    <div class="typography-row">
      ...
      <div class="typography-content decoration">
        <tiny-tooltip :effect="effect" :placement="placement" content="None-无">
          <div :class="['typography-content-item', { selected: isTextDecorationSelected('none') }]" @click="selectTextDecoration('none')">
...
import { MetaColor, MetaSelect } from '@/common';
