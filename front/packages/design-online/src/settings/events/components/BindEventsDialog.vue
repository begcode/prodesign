<template>
  <Modal v-model:open="dialogVisible" title="事件绑定" width="75%" :append-to-body="true" @close="closeDialog" @opened="openedDialog">
      ...
      <div class="content-right">
        ...
        <div :class="['content-right-bottom', { 'tip-error': !state.isValidParams }]">
          <div class="content-right-title">
            ...
            <tiny-popover placement="topLeft" width="350" trigger="hover">
              <template #content>
                <p>
          ...
          <div class="content-right-monaco">
            <monaco-editor v-if="dialogVisible" ref="editor" :value="state.editorContent" :options="editorOptions" class="monaco-editor" />
...
import { Button, Modal, Input, InputSearch, Popover, Switch } from 'ant-design-vue';
import { useCanvas, useHistory, useLayout } from '@/controller';
import { theme } from '@/controller/adapter';
import { string2Ast, ast2String } from '@/common/js/ast';
