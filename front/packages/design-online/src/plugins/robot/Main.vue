  ...
  <div class="bind-chatgpt" id="bind-chatgpt">
    <section>
      <div class="chat-title-icons">
        ...
        <svg-icon :name="chatWindowOpened ? 'chat-maximize' : 'chat-minimize'" class="common-svg" @click="resizeChatWindow"></svg-icon>
      </div>
    </section>
      ...
      <tiny-layout>
        ...
        >
          <tiny-col :span="1" :no="1" class="chat-avatar-wrap">
            <img v-if="item.role !== 'user'" class="chat-avatar chat-avatar-ai" src="@/assets/lowcode/AI.png" />
          ...
          <tiny-col :span="22" :no="2">
            <div
              :class="[
                ...
                item.role === 'user' ? 'chat-content-user' : connectedFailed ? 'chat-content-ai-unconnected' : 'chat-content-ai',
              ]"
            >
...
import {
  ...
  MenuItem as TinyDropdownItem,
} from 'ant-design-vue';
import { useCanvas, useHistory, usePage, useModal } from '@/controller';
...
export default {
  ...
  setup() {
    ...
    watchEffect(() => {
      avatarUrl.value = 'lowcode/img/defaultAvator.png';
    });
  ...
  `;
    ...
    const initChat = () => {
      ...
      messages.value.unshift({
        role: 'assistant',
        content: '你好，很高兴为你服务，请描述你的问题，方便我们能够准确回答。你好，很高兴为你服务，请描述你的问题，方便我们能够准确回答。',
        name: 'AI',
      });
      resetContent();
    };
