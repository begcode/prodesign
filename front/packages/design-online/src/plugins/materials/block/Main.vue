<template>
  <div class="blocks-wrap">
    ...
    <tiny-search v-model="state.searchValue" placeholder="请输入关键字搜索"></tiny-search>
  ...
  setup() {
    ...
    const filterBlocks = computed(() => {
      ...
      return state.groupData.filter(block => {
        ...
        return nameCN.includes(lowerCaseSearchValue) || label.includes(lowerCaseSearchValue) || description.includes(lowerCaseSearchValue);
      });
    });
