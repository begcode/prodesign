<template>
  <div class="blocks-header-wrap">
              ...
              <template #content>
                <div class="popper-confirm" @mousedown.stop="">
                  <div class="popper-confirm-header">
                    <Icon class="icon" name="warning|svg"></Icon>
                  ...
                  <div class="popper-confirm-footer">
                    ...
                    <tiny-button id="cancelDeleteGroupName" size="small" class="cancel-btn" @click="handleCancelDeleteGroup"
                      >取消</tiny-button
                    >
                  </div>
                </div>
    ...
    <svg-button v-if="!isShortcutPanel" class="add-group-btn" tips="新建分组" name="add-page|svg" @click="handleAddGroup"></svg-button>
  </div>
  <Modal v-model:open="state.showCreateGroupForm" title="新建分组" width="400px" :append-to-body="true">
...
import { Input, SelectOption, Select, Form as TinyForm, FormItem as TinyFormItem, Modal, Button, Tooltip, Popover } from 'ant-design-vue';
import { iconYes, iconClose, iconError } from '@opentiny/vue-icon';
import { useApp, useBlock, useModal } from '@/controller';
