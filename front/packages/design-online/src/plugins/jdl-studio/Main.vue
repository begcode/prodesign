<template>
  <div id="source-code">
    <div class="source-code-header">
      <!--      <div class="title">JDL-Studio</div>-->
      <!--      <div class="header-title">-->
      <!--        &lt;!&ndash; 暂时放开schema录入功能，等画布功能完善后，再打开下面一行的注释 &ndash;&gt;-->
      <!--        &lt;!&ndash; <tiny-popover v-if="isEdit" placement="bottom" trigger="hover" append-to-body content="保存"> &ndash;&gt;-->
...
import { VueMonaco, CloseIcon } from '@/common';
import { useCanvas, useModal, useHistory, useNotify } from '@/controller';
import { obj2String, string2Obj, theme } from '@/controller/adapter';
import { getSchema } from '@/canvas';
import { iconSave, iconDownloadLink } from '@opentiny/vue-icon';
import JdlStudio from '@/plugins/jdl-studio/components/JdlStudio.vue';
...
#source-code {
  width: calc(100vw - var(--base-right-panel-width) - 82px);
