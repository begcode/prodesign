  ...
  <div class="property-setting-container">
    ...
    <tiny-form class="property-form" label-position="left" label-width="110px">
      ...
      <tiny-form-item label="属性面板组件">
        <tiny-select v-model="widgetComponent" :options="widgetComponentList" @change="handleChangeWidgetComponent"></tiny-select>
        <div class="global-desc-info">区块发布后使用当前区块时，会在属性面板中使用当前选择的组件（例如MetaSelect），来配置该属性</div>
      </tiny-form-item>
      ...
      <tiny-form-item label="默认值">
        <config-item :property="defaultValueProperty" :onlyEdit="true" @update:modelValue="updateDefaultValue"></config-item>
      </tiny-form-item>
...
import { ConfigItem, MetaCodeEditor, MetaListItems } from '@/common';
      ...
      property => {
        ...
        const newDefaultValueProperty = {
          ...
          widget: {
            ...
            component: component === META_COMPONENTS_ENUM.MetaArrayItem ? META_COMPONENTS_ENUM.MetaCodeEditor : component,
          },
        };
