      ...
      <li v-for="key in filteredKey" :key="key" class="data-source-list-item">
        <div class="item-head">
          ...
          <div class="item-head-right">
            <svg-button name="edit|svg" tips="编辑" @click="openPanel(OPTION_TYPE.UPDATE, key)"></svg-button>
            <svg-button name="copy|svg" tips="复制" @click="openPanel(OPTION_TYPE.COPY, key)"></svg-button>
            <svg-button name="delete|svg" tips="删除" @click="confirmClick(key)"></svg-button>
          </div>
        </div>
      </li>
    </ul>
...
import { findExpressionInAppSchema } from '@/common/js/ast';
