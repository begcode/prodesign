<template>
  ...
  >
      ...
      >
        <template #toolbar>
          <div style="display: flex">
            <span style="margin-right: 5px">state</span>
            <tiny-popover placement="bottomLeft" effect="dark" trigger="hover" popper-class="state-data-example-tips">
    ...
    <tiny-form-item prop="getters" class="store-form-item monaco-form-item">
    ...
    <tiny-form-item prop="actions" class="store-form-item monaco-form-item">
...
import { Form, FormItem, Input, Popover } from 'ant-design-vue';
import { MonacoEditor } from '@/common';
import { theme } from '@/controller/adapter';
import { string2Ast, ast2String, insertName } from '@/common/js/ast';
