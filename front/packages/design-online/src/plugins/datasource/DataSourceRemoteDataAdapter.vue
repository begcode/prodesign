<template>
  <div>
    <remote-data-adapter-form v-model="state.shouldFetch" name="是否可以发起请求的计算函数（shouldFetch）"></remote-data-adapter-form>
    ...
    <remote-data-adapter-form v-model="state.errorHandler" name="请求失败后的回调函数（errorHandler）"></remote-data-adapter-form>
  </div>
</template>

<script>
import { reactive, ref, watch } from 'vue';
import { Popover, Alert } from 'ant-design-vue';
