<template>
  ...
  >
    <template #content>
      <div class="actions">
        <Button class="addButton" :underline="false" :disabled="!allowCreate" @click.stop="insertNewData"
          ><Icon class="tiny-svg-size icon-plusCircle" icon="plusCircle|svg"></Icon>新增静态数据</Button
        >
        <Button class="importButton" :underline="false" :disabled="!allowCreate" @click.stop="showImportModal(true)"
          ><Icon class="tiny-svg-size icon-import" icon="icon-import|svg"></Icon>批量导入</Button
        >
        <Button class="box-all-delete" type="text" :disabled="state.isBatchDeleteDisable" @click.stop="batchDelete"
          ><span class="all-delete">批量删除</span></Button
        >
        <Button class="download" :underline="false" @click="download"
          ><Icon class="tiny-svg-size icon-download" icon="icon-download|svg"></Icon>下载导入模板</Button
        >
      </div>
        ...
        >
          <template #empty>
            <div class="empty-container">
              <svg-icon class="empty-icon" name="empty|svg"></svg-icon>
              <p>
                <span>暂无数据</span>
...
import { Table, Pagination, Input, InputNumber, DatePicker, Switch, Slider } from 'ant-design-vue';
import { IconPlusCircle, IconImport } from '@opentiny/vue-icon';
import { PluginSetting } from '@/common';
import { utils } from '@/utils';
import { useModal, useLayout, useNotify } from '@/controller';
...
import { Button, Icon } from '@begcode/components';
