...
const saveMethods = () => {
  ...
  ast.program.body.forEach((declaration, index) => {
    ...
    if (ast.program.body[index + 1]?.leadingComments && declaration.trailingComments === ast.program.body[index + 1].leadingComments) {
