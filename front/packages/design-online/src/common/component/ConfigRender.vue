<template>
  <div class="properties-list">
    <tiny-collapse v-model:activeKey="activeNames" :bordered="false" :expand-icon-position="'right'">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const filterActiveGroup = data => data?.filter?.(item => !item.fold)?.map?.((item, index) => item) || [];
