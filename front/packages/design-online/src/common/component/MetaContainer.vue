  ...
  <div>
    <meta-list-items class="list" :optionsList="children">
      ...
      <template #operate="{ data }">
        <Tooltip class="item" title="删除" placement="top">
...
import { useProperties, useHistory, useResource } from '@/controller';
...
export default {
  ...
  setup() {
    ...
    const childComponentName = configureMap[componentName]?.nestingRule?.childWhitelist?.[0] || schemaChildren?.[0]?.componentName;
