<template>
  <div class="editor-wrap">
    <slot>
      ...
      <Button v-else class="edit-btn" @click="open">
        {{ buttonLabel }}
      </Button>
    </slot>
    <Modal v-model:open="editorState.show" :title="titleLabel" width="50vw" class="meta-code-editor-dialog-box" append-to-body>
      <div class="source-code">
        <div v-if="editorTipsTitle" class="header-tips-container">
          ...
          <div v-if="editorTipsDemo" class="header-tips-showdemo" @click="editorState.showEditorDemo = !editorState.showEditorDemo">
      ...
      <template #footer>
        <div class="btn-box">
          <Button danger v-if="language === 'json' && showFormatBtn" @click="formatCode">
            {{ $t('common.format') }}
          </Button>
          <div>
...
export default {
  ...
  emits: ['save', 'open', 'close', 'update:modelValue'],
  setup(props, { emit }) {
