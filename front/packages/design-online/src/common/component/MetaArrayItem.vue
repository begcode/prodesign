<template>
  <div class="meta-array-wrap">
    <meta-list>
      ...
      <template #items>
        <vue-draggable-next :list="itemsOptions.optionsList" :disabled="disableDrag" handle=".tiny-svg-size" @change="dragEnd">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const addItem = () => {
      ...
      const newOption = ['string', 'boolean', 'number'].includes(props.meta.widget.props.type) ? defaultValue : { ...defaultValue };
