<template>
  <meta-array-item :meta="meta" :expand="expand" :disableDrag="disableDrag" @update:modelValue="saveValue"></meta-array-item>
</template>

<script>
import { onMounted, onUnmounted } from 'vue';
import { useMessage, useCanvas } from '@/controller';
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const getSelectOptions = value => {
      ...
      const property = content?.find(item => item.property === CONSTANTS.FIELD && item.widget?.component === CONSTANTS.COMPONENT);
