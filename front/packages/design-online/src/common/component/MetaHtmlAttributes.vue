<template>
  <div class="attr-header">
    ...
    <tiny-popover v-model:open="state.visible" placement="bottom" title="" width="200" popper-class="option-popper" trigger="manual">
      <template #content>
        <div class="attr-form">
      ...
      <Tooltip class="item" effect="dark" content="新增原生属性" placement="top">
...
import { useProperties, useResource } from '@/controller';
import { IconDel, IconEdit, IconClose } from '@opentiny/vue-icon';
import { Form, FormItem, Input, Button, Popover, Tooltip } from 'ant-design-vue';
