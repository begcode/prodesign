<template>
  <div class="text-input">
    <Input :modelValue="inputValue" placeholder="请输入内容" v-bind="$attrs" @input="inputChange">
      <template #suffix>
        <Popover ref="popoverRef" width="260" trigger="click" :visible-arrow="false" popper-class="lowcode" @hide="onHide">
          <template #content>
