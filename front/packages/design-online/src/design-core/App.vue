...
import { ConfigProvider as TinyConfigProvider } from 'ant-design-vue';
// import designSmbConfig from '@opentiny/vue-design-smb'
import { useResource, useLayout, useEditorInfo, useModal, useApp, useNotify } from '@/controller';
import AppManage from '@/plugins/page';
