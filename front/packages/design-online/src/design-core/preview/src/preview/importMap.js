...
importMap.imports = {
  ...
  'vue/server-renderer': 'https://unpkg.com/@vue/server-renderer@3.3.6/dist/server-renderer.esm-browser.js',
  ...
  '@/design-online/webcomponent': 'https://unpkg.com/@/design-online/webcomponent@1/dist/tiny-engine-webcomponent-core.es.js',
  '@opentiny/tiny-engine-i18n-host': 'https://unpkg.com/@opentiny/tiny-engine-i18n-host@1/dist/tiny-engine-i18n-host.es.js',
  'vue-demi': 'https://unpkg.com/vue-demi@0.13.11/lib/index.mjs',
  pinia: 'https://unpkg.com/pinia@2.0.22/dist/pinia.esm-browser.js',
  'ant-design-vue': 'https://unpkg.com/ant-design-vue@4.0.6/dist/antd.esm.min.js',
  'vxe-table': 'https://unpkg.com/browse/vxe-table@4.5.13/es/index.esm.js',
  'begcode-components': 'http://localhost:3290/assets/js/components/index.js',
  ...tinyVue3Imports,
