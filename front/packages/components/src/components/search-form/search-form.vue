...
<script lang="ts">
import { Form, Row, Col, RadioGroup, Radio, RadioButton, Button } from 'ant-design-vue';
...
export default {
  name: 'BSearchForm',
  components: { BasicForm, BasicModal, SearchFormItem, FormAction, Form, Row, Col, RadioGroup, Radio, RadioButton, Button },
  props: {
    config: {
      type: Object,
      required: true,
