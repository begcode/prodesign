...
export type RegisterForm = (formInstance: FormActionType) => void;

export type UseFormReturnType = [RegisterForm, FormActionType];
...
interface BaseFormSchema {
  ...
  renderComponentContent?: ((renderCallbackParams, opts: RenderOpts) => any) | VNode | VNode[] | string;
