  ...
  <div class="clearfix">
    ...
    >
      <div v-if="uploadVisible">
        ...
        <Button v-if="listType === 'picture'" :disabled="disabled">
          <UploadOutlined />
          {{ text }}
        </Button>
      </div>
...
import { getFileAccessHttpUrl, getRandom } from '@/utils';

export default defineComponent({
  name: 'BImageUpload',
  components: { LoadingOutlined, UploadOutlined, Upload, Button, Modal },
  inheritAttrs: false,
  props: {
    //绑定值
