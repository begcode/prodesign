  ...
  setup(props, { emit, attrs }) {
    ...
    const getProps = computed(() => {
      ...
      if (mergeProps.layout === 'inline') {
        if (mergeProps.labelCol === form.labelCol) {
          mergeProps.labelCol = undefined;
        }
        if (mergeProps.wrapperCol === form.wrapperCol) {
          mergeProps.wrapperCol = undefined;
        }
      }
      return mergeProps as FormProps;
    });
    ...
    return {
      ...
      setFormModel,
      getFormClass,
      getFormActionBindProps: computed(() => ({ ...getProps.value, ...advanceState }) as InstanceType<typeof FormAction>['$props']),
      fieldsIsAdvancedMap,
      ...formActionType,
    };
  },
