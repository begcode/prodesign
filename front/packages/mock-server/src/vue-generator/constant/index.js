...
const DEFAULT_COMPONENTS_MAP = [
  ...
  },
  {
    ...
    exportName: 'Button',
    package: '@begcode/components',
    version: '1.0.0',
    destructuring: true,
  },
  {
    componentName: 'BSearchForm',
 ...
 * 协议中的类型
 */
export const [JS_EXPRESSION, JS_FUNCTION, JS_I18N, JS_RESOURCE, JS_SLOT] = ['JSExpression', 'JSFunction', 'i18n', 'JSResource', 'JSSlot'];
