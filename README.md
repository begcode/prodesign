...
本应用程序由BegCode8.0.0-rc.1生成, 你可以在 [https://www.begcode.com/documentation-archive/v8.0.0-rc.1](https://www.begcode.com/documentation-archive/v8.0.0-rc.1) 找到文档和帮助。
...
To build the final jar and optimize the prodesign application for production, run:
...
[JHipster 8.0.0-rc.1 archive]: https://www.begcode.com/documentation-archive/v8.0.0-rc.1
[Using JHipster in development]: https://www.begcode.com/documentation-archive/v8.0.0-rc.1/development/
[Using Docker and Docker-Compose]: https://www.begcode.com/documentation-archive/v8.0.0-rc.1/docker-compose
[Using JHipster in production]: https://www.begcode.com/documentation-archive/v8.0.0-rc.1/production/
[Running tests page]: https://www.begcode.com/documentation-archive/v8.0.0-rc.1/running-tests/
[Code quality page]: https://www.begcode.com/documentation-archive/v8.0.0-rc.1/code-quality/
[Setting up Continuous Integration]: https://www.begcode.com/documentation-archive/v8.0.0-rc.1/setting-up-ci/
